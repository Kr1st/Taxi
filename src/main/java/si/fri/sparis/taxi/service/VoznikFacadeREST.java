...
public class VoznikFacadeREST extends AbstractFacade<Voznik> {
    ...
    public void create(Voznik entity) {
        super.create(entity);
    }
    ...
    @Override
    @Consumes({"application/xml", "application/json"})
    public void edit(Voznik entity) {
        super.edit(entity);
    }
    ...
    public Voznik find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<Voznik> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
