...
public class UporabnikFacadeREST extends AbstractFacade<Uporabnik> {
    ...
    @Override
    @Consumes({"application/xml", "application/json"})
    public void edit(Uporabnik entity) {
        super.edit(entity);
    }
    ...
    public Uporabnik find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<Uporabnik> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
