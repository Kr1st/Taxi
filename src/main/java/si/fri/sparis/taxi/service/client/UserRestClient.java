 ...
 */
package si.fri.sparis.taxi.service.client;
...
/**
 * Jersey REST client generated for REST resource:UporabnikFacadeREST
 * [uporabnik]<br>
 * USAGE:
 * <pre>
...
public class UserRestClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/Taxi/webresources";

    public UserRestClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("uporabnik");
    }
